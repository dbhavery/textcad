...
Compare codegen models on identical prompts:
    python scripts/bench.py qwen3:14b
    python scripts/bench.py qwen2.5-coder:32b

Writes out/<safe_model>__<part>.{scad,png,stl}. Visual correctness is judged by a
human/VLM looking at the PNGs.
"""
from __future__ import annotations

import sys

from textcad import run
